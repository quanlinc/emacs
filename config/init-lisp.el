;;; init-lisp.el --- Emacs lisp setting
;;; Commentary:
;;; Code:
;; TODO: paredit will conflict with parenthesis navigation that I'm used to, need some more learning to have this issue fixed
